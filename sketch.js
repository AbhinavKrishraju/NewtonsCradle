...
function setup() {
	...
	ball1 = Bodies.circle(320,350,10,ball_options);
     World.add(world,ball1);

	ball2 = Bodies.circle(360,350,10,ball_options);
	 World.add(world,ball1);

	ball3 = Bodies.circle(400,350,10,ball_options);
	World.add(world,ball1);

	ball4 = Bodies.circle(440,350,10,ball_options);
    World.add(world,ball1);

    ball5 = Bodies.circle(480,350,10,ball_options);
...
function keyPressed()
{
  if(keyCode===UP_ARROW)
    {
      Matter.Body.applyForce(ball1,ball1.position,{x:-50,y:-20});
